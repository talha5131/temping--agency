			...
			<div class="container">
				...
				<div class="row about-wrapper-bottom">
					...
					<div class="col-md-6 ts-padding about-message">
						...
						<p>  As a temping agency we vetted all candidates with great vigour. Being a top temp agency our consultants not only present the candidate’s CV, but also with test results of their skills and full reference checks.	  </p> <br> 
				...
				<div class="row about-wrapper-top">
					...
					<div class="col-md-12 ts-padding about-message">
						...
						<ul class="unstyled arrow">
							...
							<li> You may need them to meet other terms and conditions that will suit your company and these you will need to negotiate with the temping agency. </li>
