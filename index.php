						...
						<div class="col-md-12">
							<div class="col-md-4 col-sm-3 wow fadeInDown" data-wow-delay=".5s">
								<div class="service-content text-center">
									...
									<p> We have a large pool of candidates, who always ready to start a job on short notice. This means that our team…</p> <br>
									<a href="service1.html" class="btn btn-primary cd-btn">Read More</a>
							...
							<div class="col-md-4 col-sm-3 wow fadeInDown" data-wow-delay=".8s" >
								<div class="service-content text-center">
									...
									<a href="service2.html" class="btn btn-primary cd-btn">Read More</a>
								</div>
							...
							<div class="col-md-4 col-sm-3 wow fadeInDown" data-wow-delay="1.1s">
								<div class="service-content text-center">
									...
									<h3>  Staff on Call</h3>
									<p>  One of the benefits of having access to temporary staff is that you can arrange for staff to be on call. This means that your chosen…</p> <br>
									<a href="service3.html" class="btn btn-primary cd-btn">Read More</a>
					...
					<div class="row">	 
						<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay=".5s">
							<div class="service-content text-center">
								...
								<p> There are many positions that could arise in an industrial setting. Workers Direct will be able to fill any of them on short notice…</p> <br>
								<a href="service4.html" class="btn btn-primary cd-btn">Read More</a>
							</div>
						</div><!--/ End first service -->
						...
						<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay=".8s" >
							<div class="service-content text-center">
								...
								<h3>  Temporary Labourer </h3>
								<p>  Temping Agency has developed a name as one of the very best labourer agencies in London. We aim to offer our customers top…</p> <br>
								<a href="service5.html" class="btn btn-primary cd-btn">Read More</a>
						...
						<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay="1.1s">
							<div class="service-content text-center">
								...
								<h3> Ready Talent</h3>
								<p>  Call us to hire any temp whenever you needs from our big pool of talent – Temps registered with us are always ready to fit right…</p> <br>
								<a href="service6.html" class="btn btn-primary cd-btn">Read More</a>
							</div>
						</div><!--/ End Third service -->
						...
						<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay="1.4s">
							<div class="service-content text-center">
								...
								<h3>  Agency Temps</h3>
								<p>  Very often a company has the need for a temporary employee and then decides to employ that person on a permanent basis…</p> <br>
								<a href="service7.html" class="btn btn-primary cd-btn">Read More</a>
